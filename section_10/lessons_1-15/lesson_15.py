# 305. Remove Circular References Challenge
...
class Artist:
    ...
    Atttibutres:
        ...
        albums (List[Album]): A list of the albums by this artist.
            ...
            not an ehausive list of the artist's published albums.
    ...
    def add_song(self, name, year, title):
        """Add a new song to the collection og the albums
        
        This method will add the song to an album in the collection.
        A new album will be created in the collection if ir doesn't exist.
...
def find_object(field, object_list):
    """Check 'object_list' to see if an object with a 'name' attributed to 'field' exists, return it if so."""
